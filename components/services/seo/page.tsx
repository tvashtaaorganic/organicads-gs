                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="text-center lg:text-left">
                            ...
                            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto lg:mx-0 leading-relaxed mb-8">
                                Dominate search results with expert {service.name} services in {service.locationin}.
                            </p>
                            ...
                            <div className="flex flex-wrap justify-center lg:justify-start gap-4 mb-12">
                                ...
                                <a href="#results" className="px-8 py-3 bg-white dark:bg-gray-800 text-gray-900 dark:text-white border border-gray-200 dark:border-gray-700 rounded-full font-semibold hover:border-gray-300 dark:hover:border-gray-600 transition-all text-lg">
                                    View Results
                                </a>
                            </div>
