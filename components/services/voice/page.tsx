...
export default function VoiceService({ service }: VoiceServiceProps) {
        ...
        <div className="min-h-screen">
            ...
            <section className="relative min-h-[60vh] flex items-center justify-center px-4 pt-24 pb-12 overflow-hidden">
                ...
                <div className="relative z-10 max-w-6xl mx-auto text-center">
                    ...
                    <Badge className="mb-6 px-6 py-3 text-base font-medium bg-orange-500/20 border-orange-500/40 hover:bg-orange-500/30 text-primary-foreground">
                        <Zap className="w-5 h-5 mr-2 inline fill-current" />
                        Automated IVR & Voice OTP - Boost Conversions by 300%!
                    </Badge>
                    ...
                    <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                        {service.descpost === 'domestic'
                            ? `Supercharge customer engagement with intelligent IVR systems, automated outbound calls, and voice OTP solutions across India.`
                            : `Transform global customer interactions with enterprise voice solutions featuring advanced IVR, call tracking, and voice authentication.`
                        }
                    </p>
                </div>
            </section>
