    ...
    return (
        <div className="min-h-screen">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="text-center lg:text-left">
                            ...
                            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto lg:mx-0 leading-relaxed mb-8">
                                Scaling your business with expert {service.name} solutions tailored for {service.locationin}.
                            </p>
            ...
            <LocalAreasServed
                ...
                parentSlug={service.servicename === 'dm' ? 'digital-marketing' : service.servicename}
            />
