                        ...
                        <div className="text-center lg:text-left">
                            ...
                            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto lg:mx-0 leading-relaxed mb-8">
                                {service.descpost === 'domestic'
                                    ? `Unify your customer communication with integrated multi-channel marketing campaigns across India for maximum reach and engagement.`
                                    : `Orchestrate seamless customer journeys across all touchpoints globally with comprehensive multi-channel strategies.`
                                }
                            </p>
