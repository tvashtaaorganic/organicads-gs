...
interface BackendCloudServiceProps {
    service: {
        id: number;
        name: string;
        locationin: string;
...
export default function BackendCloudService({ service }: BackendCloudServiceProps) {
    ...
    return (
        <div className="min-h-screen">
            ...
            <section className="relative min-h-[60vh] flex items-center justify-center px-4 pt-24 pb-12 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/10 via-background to-blue-600/10" />
                ...
                <div className="relative z-10 max-w-6xl mx-auto text-center">
                    ...
                    <Badge className="mb-6 px-6 py-3 text-base font-medium bg-indigo-600/20 border-indigo-600/40 hover:bg-indigo-600/30 text-primary-foreground">
                        <Zap className="w-5 h-5 mr-2 inline fill-current" />
                        Scalable AWS Infrastructure - 99.99% Uptime Guaranteed!
                    </Badge>
                    ...
                    <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                        {service.descpost === 'domestic'
                            ? `Build robust, scalable backends with AWS, Turso, SQL Server, and Node.js - powering India's fastest-growing applications.`
                            : `Deploy enterprise-grade cloud infrastructure with AWS, advanced databases, and microservices architecture for global scale.`
                        }
                    </p>
                </div>
            </section>
