...
export default function WebDevService({ service }: WebDevServiceProps) {
            ...
            <section className="relative min-h-[60vh] flex items-center justify-center px-4 pt-24 pb-12 overflow-hidden">
                ...
                <div className="relative z-10 max-w-6xl mx-auto text-center">
                    ...
                    <Badge className="mb-6 px-6 py-3 text-base font-medium bg-primary/20 border-primary/40 hover:bg-primary/30 text-primary-foreground">
                        ...
                        High-Performance Custom Websites Delivered Fast!
                    </Badge>
                    ...
                    <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                        {service.descpost === 'domestic'
                            ? `Crafting high-performance digital experiences for leading brands in India.`
                            : `Building scalable, world-class web solutions for global enterprises.`
                        }
                    </p>
                </div>
            </section>
